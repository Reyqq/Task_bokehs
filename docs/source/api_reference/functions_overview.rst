...
- :func:`plot_trading_signals(df: pd.DataFrame,positions_df: Optional[pd.DataFrame] = None, ...) <bokehs.plot_trading_signals>`: Создает интерактивный график с торговыми сигналами на основе данных свечей и информации о позициях.
